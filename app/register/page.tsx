              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="auth-form-element space-y-1">
                  ...
                  <input
                    ...
                    name="date"
                    type="date"
                    className="block w-full rounded-full border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-right shadow-inner focus:border-red-600 focus:outline-none focus:ring-2 focus:ring-red-100"
                  />
                </div>
              </div>
