...
const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    description: null,
    image:
      "https://academy.aca.gov.eg:8989/Media/GENType/Images/37/T_T_638064316592642486.jpg",
  ...
  },
  {
    ...
    description: null,
    image:
      "https://academy.aca.gov.eg:8989/Media/GENType/Images/176/T_T_638097344640345165.jpg",
  ...
  },
  {
    ...
    description: null,
    image:
      "https://academy.aca.gov.eg:8989/Media/GENType/Images/38/T_T_638064320486901887.jpg",
    priceString: "3,000 EGP",
    isFree: false,
  },
  {
    ...
    description: null,
    image:
      "https://academy.aca.gov.eg:8989/Media/GENType/Images/155/T_T_638064400336658136.jpg",
    priceString: "600 EGP",
    isFree: false,
  },
  {
    ...
    description: null,
    image:
      "https://academy.aca.gov.eg:8989/Media/GENType/Images/48/T_T_638064326199994491.jpg",
    priceString: "3,000 EGP",
    isFree: false,
  },
  {
    ...
    description: null,
    image:
      "https://academy.aca.gov.eg:8989/Media/GENType/Images/175/T_T_638091182874640817.jpg",
...
export default function Services() {
  ...
  return (
    <section className="relative py-12 overflow-x-hidden" dir="rtl">
      <StripedPattern
        direction="right"
        width={12}
        height={12}
        className="text-red-600/10 -z-10"
      />
      <div className="w-[90%] max-w-full mx-auto relative z-0">
        <BlurFade>
        ...
        <BlurFade duration={0.6} delay={0.2} offset={10} direction="left">
          ...
          >
            <motion.div
              ...
              className="min-w-0 md:col-span-2 md:row-span-2 min-h-[280px] md:min-h-[400px]"
            >
              <ServiceBentoCard
                item={first}
                size="large"
        ...
        <BlurFade duration={0.6} delay={0.2} offset={10} direction="left">
          <div className="w-full flex justify-center my-20">
            <InteractiveHoverButton dir="ltr">
              <Link href="/services">المزيد من الخدمات</Link>
