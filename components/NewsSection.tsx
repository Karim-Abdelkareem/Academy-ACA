...
const NEWS_DATA: NewsItem[] = [
  {
    ...
    image:
      "https://academy.aca.gov.eg:8989/Media/GENWiki/Images/21011/N_W_639057998157055499.jpg",
    richContent: null,
    isActive: true,
    isPublish: true,
  },
  {
    ...
    image:
      "https://academy.aca.gov.eg:8989/Media/GENWiki/Images/21010/N_W_639052013668531485.jpg",
  ...
  },
  {
    ...
    image:
      "https://academy.aca.gov.eg:8989/Media/GENWiki/Images/21008/N_W_639046955130094781.jpg",
  ...
  },
  {
    ...
    image:
      "https://academy.aca.gov.eg:8989/Media/GENWiki/Images/21007/N_W_639046835778703301.jpg",
    richContent:
      'ندوة بعنوان " دور هيئة الرقابة الإدارية في استحداث أدوات لمنع ومكافحة الفساد"',
    isActive: true,
    isPublish: true,
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 flex items-start justify-between">
        ...
        <span className="text-white/70 text-xs font-mono bg-black/20 backdrop-blur-sm px-2 py-1 rounded-md">
          {item.year}
        </span>
      </div>
      ...
      <div className="relative z-10 flex items-center gap-6 p-6 w-full">
        <div className="hidden md:flex flex-col items-center gap-1 shrink-0">
          ...
          <span className="text-neutral-400 text-xs font-mono">
            {item.date1String.split("/")[1]}/
            {item.date1String.split("/")[2].split(" ")[0]}
          </span>
        </div>
        <div className="w-px h-12 bg-red-200 hidden md:block shrink-0" />
        <div className="flex-1 min-w-0">
          <p className="text-red-500 text-xs font-mono tracking-wider mb-2 md:hidden">
            {formatDate(item.date1String)}
          </p>
          ...
          <BlurFade duration={0.6} delay={0.2} offset={10} direction="left">
            <div className="w-full flex justify-center my-20">
              <InteractiveHoverButton dir="ltr">
                <Link href="/news">المزيد من الأخبار</Link>
